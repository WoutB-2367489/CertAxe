...
@Service
public class CertificateDuckDBDatabase implements CertificateAppender {

    private final Connection connection;
    private static final Logger logger = LoggerFactory.getLogger(CertificateDuckDBDatabase.class);
...
//          extensionCount            INTEGER,
    ...
    public CertificateDuckDBDatabase(ProgressPostgresDatabase progressDatabase) throws SQLException {
